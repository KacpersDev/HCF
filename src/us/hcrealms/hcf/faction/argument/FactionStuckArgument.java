  ...
  extends CommandArgument
{
  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
  {
    ...
    sender.sendMessage(ChatColor.RED + stuckTimer.getDisplayName() + ChatColor.RED + " timer has started. " + "Teleportation will commence in " + ChatColor.LIGHT_PURPLE + Base.getRemaining(stuckTimer.getRemaining(player), true, false) + ChatColor.RED + ". " + "This will cancel if you move more than " + 5 + " blocks.");
    return true;
  }
}

package us.hcrealms.hcf.classes;
...
public abstract class PvpClass
{
  ...
  public boolean onEquip(Player player)
  {
    ...
    player.sendMessage(ChatColor.GREEN + "Class " + ChatColor.GREEN + this.name + ChatColor.GREEN + " has been equipped.");
    return true;
  }
  ...
  public void onUnequip(Player player)
  {
    ...
    player.sendMessage(ChatColor.GREEN + "Class " + ChatColor.GREEN + this.name + ChatColor.GREEN + " has been un-equipped.");
  }

package us.hcrealms.hcf.classes.bard;
...
@EventHandler(ignoreCancelled=false, priority=EventPriority.MONITOR)
  ...
  private boolean canUseBardEffect(Player player, BardData bardData, BardEffect bardEffect, boolean sendFeedback)
  {
    ...
    if (remaining > 0L) {
      errorFeedback = ChatColor.RED + "You still have a cooldown on this " + ChatColor.GREEN + ChatColor.BOLD + "Bard" + ChatColor.RED + " buff for another " + Base.getRemaining(remaining, true, false) + ChatColor.RED + '.';
    }

		...
		if (cmd.getName().equalsIgnoreCase("god")) {
			...
			if (args.length < 1) {
				...
				if (GodListener.getInstance().isinGod(p)) {
					...
					sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&7You have &cdisabled &7your &3&lGod Mode"));
					return true;
				}
				GodListener.getInstance().setGod(p, true);
				sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&7You have &aenabled &7your &3&lGod Mode"));
				return true;
			}
			...
			if (GodListener.getInstance().isinGod(t)) {
				...
				sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&7You have &cdisabled &7" + t.getName() + "'s &3&lGod Mode"));
				return true;
			}
			GodListener.getInstance().setGod(t, true);
			t.setAllowFlight(true);
			sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&7You have &aenabled &7" + t.getName() + "'s &3&lGod Mode"));
			return true;
		}
		return false;
	}

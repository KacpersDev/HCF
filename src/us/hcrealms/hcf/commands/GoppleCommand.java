...
public class GoppleCommand implements CommandExecutor, TabCompleter {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		sender.sendMessage(
				ChatColor.GRAY + "Your " + ChatColor.AQUA + timer.getDisplayName() + ChatColor.GRAY + " timer is active for another "
						+ ChatColor.AQUA + Base.getRemaining(remaining, true, false) + ChatColor.GRAY + '.');
		return true;
	}

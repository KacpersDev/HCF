...
public class KingReviveCommand implements CommandExecutor {
	...
	public boolean onCommand(final CommandSender sender, final Command command, final String label,
		...
		Bukkit.broadcastMessage(ChatColor.GOLD + sender.getName() + ChatColor.YELLOW + " has revived " + ChatColor.GOLD + target.getName() + ChatColor.YELLOW + " with their King rank.");

...
public class FactionWithdrawArgument extends CommandArgument {
	...
	public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        playerFaction.broadcast(ChatColor.LIGHT_PURPLE + factionMember.getRole().getAstrix() + sender.getName() + ChatColor.YELLOW + " withdrew " + ChatColor.LIGHT_PURPLE + '$' + JavaUtils.format((Number) amount) + ChatColor.YELLOW + " from the team balance.");
        return true;
    }

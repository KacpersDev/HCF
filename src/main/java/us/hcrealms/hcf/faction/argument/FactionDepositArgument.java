...
public class FactionDepositArgument extends CommandArgument {
	...
	public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        playerFaction.broadcast(ChatColor.LIGHT_PURPLE + playerFaction.getMember(player).getRole().getAstrix() + sender.getName() + ChatColor.YELLOW + " has deposited " + ChatColor.LIGHT_PURPLE + '$' + JavaUtils.format((Number) amount) + ChatColor.YELLOW + " into the faction balance.");
        return true;
    }

package us.hcrealms.hcf.faction.claim;
...
public class ClaimSelection implements Cloneable {
    ...
    public int getPrice(final PlayerFaction playerFaction, final boolean selling) {
        ...
        return (this.pos1 == null || this.pos2 == null) ? 0 : Base.getPlugin().getClaimHandler().calculatePrice(new Cuboid(this.pos1, this.pos2), playerFaction.getClaims().size(), selling);
    }

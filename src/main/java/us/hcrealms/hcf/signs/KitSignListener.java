    ...
    public void onclicksigncrowbarbuy(final PlayerInteractEvent e) {
        ...
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (state instanceof Sign) {
                ...
                if (s.getLine(0).equals(ChatColor.translateAlternateColorCodes('&', "&9[Kit]")) && s.getLine(1).equals("PvP")) {
                    Kit.giveDiamondKit(p);
                   	p.sendMessage(ChatColor.GREEN + "You have received Diamond kit.");
                }
                else if (s.getLine(0).equals(ChatColor.translateAlternateColorCodes('&', "&9[Kit]")) && s.getLine(1).equals("Bard")) {
                	Kit.giveBardKit(p);
                   	p.sendMessage(ChatColor.GREEN + "You have received Bard kit.");
                }
                else if (s.getLine(0).equals(ChatColor.translateAlternateColorCodes('&', "&9[Kit]")) && s.getLine(1).equals("Archer")) {
                	Kit.giveArcherKit(p);
                   	p.sendMessage(ChatColor.GREEN + "You have received Archer kit.");
                }
                else if (s.getLine(0).equals(ChatColor.translateAlternateColorCodes('&', "&9[Kit]")) && s.getLine(1).equals("Rogue")) {
                	Kit.giveRogueKit(p);
                	p.sendMessage(ChatColor.GREEN + "You have received Rogue kit.");
                }
                else if (s.getLine(0).equals(ChatColor.translateAlternateColorCodes('&', "&9[Kit]")) && s.getLine(1).equals("Builder")) {
                	Kit.giveBuildKit(p);
                   	p.sendMessage(ChatColor.GREEN + "You have received Builder kit.");
                }
                else if (s.getLine(0).equals(ChatColor.translateAlternateColorCodes('&', "&9[Kit]")) && s.getLine(1).equals("Miner")) {
                	Kit.giveMinerKit(p);

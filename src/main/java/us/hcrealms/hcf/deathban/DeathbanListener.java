package us.hcrealms.hcf.deathban;
...
import us.hcrealms.hcf.util.DelayedMessageRunnable;
...
public class DeathbanListener implements Listener {
	...
	public void onPlayerLogin(PlayerLoginEvent event) {
		...
		if (lives <= 0) { // If the user has no lives, inform that they need some.
			...
			System.out.println(event.getPlayer().getName() + " attempted to join but was denied due to player being deathbanned");

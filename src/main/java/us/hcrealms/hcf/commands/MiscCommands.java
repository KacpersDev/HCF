	...
	public boolean onCommand (final CommandSender sender, final Command cmd, final String commandLabel, final String[] args) {
		...
		if (cmd.getName().equalsIgnoreCase("drop")) {
			...
			if (args[0].equalsIgnoreCase("help") | args[0].equalsIgnoreCase("helpme") | args[0].equalsIgnoreCase("help")) {
				p.sendMessage(ChatColor.RED + "\u2727 " + ChatColor.BLUE + ChatColor.BOLD + "                     Help Menu                            " + ChatColor.RED + " \u2727");
				p.sendMessage(ChatColor.RED + "[" + ChatColor.GRAY + "+" + ChatColor.RED + "]" + ChatColor.GRAY + " /drop is a command that allows the user to remotely drop a target for a minecraft error message.");
				p.sendMessage(ChatColor.RED + "[" + ChatColor.GRAY + "+" + ChatColor.RED + "]" + ChatColor.GRAY + " There are many diffrent options to choose from.");
				p.sendMessage(ChatColor.GRAY + "- " + ChatColor.BLUE + "To drop a player do §7/drop §9<§7player§9> <§7error§9>");
				p.sendMessage(ChatColor.GRAY + "- " + ChatColor.BLUE + "To list the types of error's do §7/drop type");
				p.sendMessage(ChatColor.GRAY + "- " + ChatColor.BLUE + "To get a list of error's and the number do §7/drop list");
				return true;
			}
			if (args[0].equalsIgnoreCase("types") | args[0].equalsIgnoreCase("type") | args[0].equalsIgnoreCase("t")) {
				p.sendMessage(ChatColor.RED + "\u2727 " + ChatColor.BLUE + ChatColor.BOLD + "   All Types Of Errors   " + ChatColor.RED + " \u2727");
				p.sendMessage(ChatColor.RED + "[" + ChatColor.GRAY + "+" + ChatColor.RED + "]" + ChatColor.GRAY + " <error> - <kick message>");
			...
			if (args[0].equalsIgnoreCase("list") | args[0].equalsIgnoreCase("all") | args[0].equalsIgnoreCase("number")) {
				p.sendMessage(ChatColor.RED + "\u2727 " + ChatColor.BLUE + ChatColor.BOLD + " Lists Of Errors " + ChatColor.RED + " \u2727");
				p.sendMessage(ChatColor.RED + "[" + ChatColor.GRAY + "+" + ChatColor.RED + "]" + ChatColor.GRAY + " /drop <number>");
			...
			if (args.length == 2) {
				if (args[1].equalsIgnoreCase("stream") | args[1].equalsIgnoreCase("eos") | args[1].equalsIgnoreCase("logout") | args[1].equalsIgnoreCase("1")) {
					...
					p.sendMessage(ChatColor.GRAY + "You have droped " + ChatColor.RED + args[0] + ChatColor.GRAY + " for End of stream");
					return true;
				}
				if (args[1].equalsIgnoreCase("hacked") | args[1].equalsIgnoreCase("location") | args[1].equalsIgnoreCase("dl") | args[1].equalsIgnoreCase("2")) {
					...
					p.sendMessage(ChatColor.GRAY + "You have droped " + ChatColor.RED + args[0] + ChatColor.GRAY + " for location log in");
					return true;
				}
				if (args[1].equalsIgnoreCase("error") | args[1].equalsIgnoreCase("javaerror") | args[1].equalsIgnoreCase("503") | args[1].equalsIgnoreCase("3")) {
					...
					p.sendMessage(ChatColor.GRAY + "You have droped " + ChatColor.RED + args[0] + ChatColor.GRAY + " for Java Error");
					return true;
				}
				if (args[1].equalsIgnoreCase("login") | args[1].equalsIgnoreCase("fl") | args[1].equalsIgnoreCase("faildlogin") | args[1].equalsIgnoreCase("4")) {
					...
					p.sendMessage(ChatColor.GRAY + "You have droped " + ChatColor.RED + args[0] + ChatColor.GRAY + " for Failed to login");
					return true;
				}
				if (args[1].equalsIgnoreCase("drop") | args[1].equalsIgnoreCase("default") | args[1].equalsIgnoreCase("bye") | args[1].equalsIgnoreCase("5")) {
					target3.kickPlayer("Java Exception: Socket reset | End of Stream | in com.bukkit.minecraftServer.Connection ln 3712 at Java.Sockets.Connection.TCP Unhandled exception: Java.Exception.Streams.EndOFStream");
					p.sendMessage(ChatColor.GRAY + "You have droped " + ChatColor.RED + args[0] + ChatColor.GRAY + " for Long Error");
					return true;
				}
			}
			else {
		...
		Bukkit.broadcastMessage(ChatColor.GOLD + "\u2588\u2588" + ChatColor.DARK_RED + "\u2588" + ChatColor.GOLD + "\u2588\u2588" + ChatColor.DARK_RED + "\u2588" + ChatColor.GOLD + "\u2588\u2588" + ChatColor.DARK_RED + "\u2588" + ChatColor.GOLD + "\u2588\u2588");
		Bukkit.broadcastMessage(ChatColor.GOLD + "\u2588" + ChatColor.DARK_RED + "\u2588" + ChatColor.GOLD + "\u2588\u2588\u2588" + ChatColor.DARK_RED + "\u2588" + ChatColor.GOLD + "\u2588\u2588\u2588" + ChatColor.DARK_RED + "\u2588" + ChatColor.GOLD + "\u2588");
		Bukkit.broadcastMessage(ChatColor.GOLD + "\u2588" + ChatColor.DARK_RED + "\u2588" + ChatColor.GOLD + "\u2588\u2588\u2588\u2588\u2588\u2588\u2588" + ChatColor.DARK_RED + "\u2588" + ChatColor.GOLD + "\u2588" + "  " + ChatColor.RED + "Server Restarting.");

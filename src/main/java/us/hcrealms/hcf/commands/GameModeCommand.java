...
public class GameModeCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		Command.broadcastCommandMessage(sender, ChatColor.GRAY + "Set gamemode of " + ChatColor.AQUA + target.getName() + ChatColor.GRAY + " to " + ChatColor.AQUA + mode.name() + ChatColor.GRAY + '.');
		return true;
	}
